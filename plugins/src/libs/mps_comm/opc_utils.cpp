...
bool
OpcUtils::ReturnValue::isEmpty()
{
	return isEmpty_;
}

bool
OpcUtils::ReturnValue::isVector()
{
	return isVector_;
}

bool
OpcUtils::ReturnValue::isScalar()
{
	return !isVector_;
}

OpcUa::VariantType
OpcUtils::ReturnValue::getType()
{
	return type_;
}

void
OpcUtils::ReturnValue::setType(OpcUa::VariantType type)
{
	type_ = type;
}

std::string
OpcUtils::ReturnValue::ToString()
{
	if (!isVector_) {
		switch (type_) {
		case OpcUa::VariantType::UINT16: return std::to_string(uint16_s);
		case OpcUa::VariantType::UINT32: return std::to_string(uint32_s);
		case OpcUa::VariantType::UINT64: return std::to_string(uint64_s);
		case OpcUa::VariantType::INT16: return std::to_string(int16_s);
		case OpcUa::VariantType::INT32: return std::to_string(int32_s);
		case OpcUa::VariantType::INT64: return std::to_string(int64_s);
		case OpcUa::VariantType::FLOAT: return std::to_string(float_s);
		case OpcUa::VariantType::DOUBLE: return std::to_string(double_s);
		case OpcUa::VariantType::BOOLEAN: return std::to_string(bool_s);
		case OpcUa::VariantType::BYTE: return str2byteStr(OpcUa::Variant(uint8_s).ToString());
		default: return string_s;
		}
	}
...
OpcUtils::ReturnValue::ToStringVector()
{
	if (isVector_) {
...
size_t
OpcUtils::ReturnValue::ToInt()
{
	if (!isVector_) {
		switch (type_) {
		case OpcUa::VariantType::UINT16: return uint16_s;
		case OpcUa::VariantType::UINT32: return uint32_s;
		case OpcUa::VariantType::UINT64: return uint64_s;
		case OpcUa::VariantType::INT16: return int16_s;
		case OpcUa::VariantType::INT32: return int32_s;
		case OpcUa::VariantType::INT64: return int64_s;
		case OpcUa::VariantType::FLOAT: return float_s;
		case OpcUa::VariantType::DOUBLE: return double_s;
		case OpcUa::VariantType::BOOLEAN: return bool_s;
		case OpcUa::VariantType::BYTE: return uint8_s;
		default: try { return atoi(string_s.c_str());
...
std::vector<size_t>
OpcUtils::ReturnValue::ToIntVector()
{
	if (isVector_) {
...
void
OpcUtils::ReturnValue::setArray(const OpcUa::Variant &val)
{
	isVector_ = true;
	isEmpty_  = false;
	switch (val.Type()) {
	case OpcUa::VariantType::UINT16: uint16_v = val.As<std::vector<uint16_t>>(); break;
	case OpcUa::VariantType::UINT32: uint32_v = val.As<std::vector<uint32_t>>(); break;
	case OpcUa::VariantType::UINT64: uint64_v = val.As<std::vector<uint64_t>>(); break;
	case OpcUa::VariantType::INT16: int16_v = val.As<std::vector<int16_t>>(); break;
	case OpcUa::VariantType::INT32: int32_v = val.As<std::vector<int32_t>>(); break;
	case OpcUa::VariantType::INT64: int64_v = val.As<std::vector<int64_t>>(); break;
	case OpcUa::VariantType::FLOAT: float_v = val.As<std::vector<float>>(); break;
	case OpcUa::VariantType::DOUBLE: double_v = val.As<std::vector<double>>(); break;
	case OpcUa::VariantType::BOOLEAN: bool_v = val.As<std::vector<bool>>(); break;
	case OpcUa::VariantType::BYTE: uint8_v = val.As<std::vector<uint8_t>>(); break;
	default: string_v = val.As<std::vector<std::string>>(); break;
	}
}

void
OpcUtils::ReturnValue::setValue(const OpcUa::Variant &val)
{
	isVector_ = false;
	isEmpty_  = false;
	switch (val.Type()) {
	case OpcUa::VariantType::UINT16: uint16_s = static_cast<uint16_t>(val); break;
	case OpcUa::VariantType::UINT32: uint32_s = static_cast<uint32_t>(val); break;
	case OpcUa::VariantType::UINT64: uint64_s = static_cast<uint64_t>(val); break;
	case OpcUa::VariantType::INT16: int16_s = static_cast<int16_t>(val); break;
	case OpcUa::VariantType::INT32: int32_s = static_cast<int32_t>(val); break;
	case OpcUa::VariantType::INT64: int64_s = static_cast<int64_t>(val); break;
	case OpcUa::VariantType::FLOAT: float_s = static_cast<float>(val); break;
	case OpcUa::VariantType::DOUBLE: double_s = static_cast<double>(val); break;
	case OpcUa::VariantType::BOOLEAN: bool_s = static_cast<bool>(val); break;
	case OpcUa::VariantType::BYTE: uint8_s = static_cast<uint8_t>(val); break;
	default: string_s = static_cast<std::string>(val); break;
	}
}
...
std::string
OpcUtils::strLst(std::string l, std::string r)
{
...
std::string
OpcUtils::str2byteStr(std::string data)
{
	return str2hexStr(data) + " " + str2bitsStr(data);
}

std::string
OpcUtils::str2hexStr(std::string data)
{
	std::stringstream ss;
	ss << std::hex;
...
std::string
OpcUtils::str2bitsStr(std::string data)
{
	std::stringstream ss;
	ss << std::hex;
	for (size_t i = 0; i < data.length(); ++i)
...
bool
OpcUtils::setNodeValue(OpcUa::Node node, boost::any val, OpcUtils::ReturnValue *retVal)
{
...
OpcUa::Node
OpcUtils::getNode(OpcUa::UaClient *client, MPSRegister reg, bool simulation)
{
	if (!simulation)
...
OpcUa::Variant
OpcUtils::getNodeValueWithCorrectType(OpcUa::Node node, boost::any val)
{
...
OpcUa::Node
OpcUtils::getBasicNode(OpcUa::UaClient *client, bool simulation)
{
	if (!simulation)
...
OpcUa::Node
OpcUtils::getInNode(OpcUa::UaClient *client, bool simulation)
{
	if (!simulation)
...
OpcUtils::getNodeRelativePath(MPSRegister reg)
{
	...
	case MPSRegister::ACTION_ID_BASIC: return {"4:p", "4:ActionId"};
	case MPSRegister::BARCODE_IN:
	case MPSRegister::BARCODE_BASIC: return {"4:p", "4:BarCode"};
	case MPSRegister::DATA_IN:
	case MPSRegister::DATA_BASIC: return {"4:p", "4:Data"};
	case MPSRegister::ERROR_IN:
	case MPSRegister::ERROR_BASIC: return {"4:p", "4:Error"};
	case MPSRegister::SLIDECOUNT_IN:
	case MPSRegister::SLIDECOUNT_BASIC: return {"4:p", "4:SlideCnt"};
	case MPSRegister::STATUS_BUSY_IN:
	case MPSRegister::STATUS_BUSY_BASIC: return {"4:p", "4:Status", "4:Busy"};
	case MPSRegister::STATUS_ENABLE_IN:
	case MPSRegister::STATUS_ENABLE_BASIC: return {"4:p", "4:Status", "4:Enable"};
	case MPSRegister::STATUS_ERROR_IN:
	case MPSRegister::STATUS_ERROR_BASIC: return {"4:p", "4:Status", "4:Error"};
	case MPSRegister::STATUS_READY_IN:
	case MPSRegister::STATUS_READY_BASIC: return {"4:p", "4:Status", "4:Ready"};
	default: return {};
	}
}
...
std::string
OpcUtils::GetNodeClassName(OpcUa::NodeClass nodeClass)
{
	std::string result;
...
std::string
OpcUtils::GetNodeAccessLevelName(OpcUa::VariableAccessLevel accessLevel)
{
	std::string result;
...
bool
OpcUtils::logNodeInfo(OpcUa::Node                     node,
                      ...
                      int                             depth)
{
	try {
		...
		logger->info("{}Access level: {} ({})",
		             std::string(lvl[1], ' '),
		             tmp,
		             OpcUa::ToString(
		               node.GetAttribute(OpcUa::AttributeId::UserAccessLevel).Value.Type()));
...
bool
OpcUtils::logNodeValue(OpcUa::Node                     node,
                       std::string                     nodeName,
                       std::shared_ptr<spdlog::logger> logger,
                       int                             indent)
{
	...
	try {
		...
		if (!val.IsNul() && type != OpcUa::VariantType::NUL) {
			if (val.IsArray())
				...
				switch (val.Type()) {
				case OpcUa::VariantType::LOCALIZED_TEXT: tmp = val.As<OpcUa::LocalizedText>().Text; break;
				case OpcUa::VariantType::BYTE: tmp = str2byteStr(val.ToString()); break;
				default: try { tmp = val.ToString();
					} catch (const std::exception &e) {
                       ...
                       int                             indent)
{
	...
	if (indent >= 0)
		logger->info(("{}" + std::string(msg)).c_str(),
		             std::string(lvl[1], ' '),
		             nodeName,
		             tmp,
		             OpcUa::ToString(val.Type()),
...
std::string
OpcUtils::logNodeValueArray(OpcUa::Node                     node,
                            std::string                     nodeName,
                            std::shared_ptr<spdlog::logger> logger,
                            int                             indent)
{
                         ...
                         std::string                     msg)
{
	...
	logger->info("{}{}{}: {} ({}{})",
	             msg,
	             msg.empty() ? "" : std::string(" ", lvl[0]),
	             OpcUtils::REGISTER_NAMES[reg],
	             retVal,
	             OpcUa::ToString(val->getType()),
	             val->isVector() ? "[]" : "");
	return true;
}
...
bool
OpcUtils::browseServer(OpcUa::UaClient *client, std::shared_ptr<spdlog::logger> logger)
{
	try {
